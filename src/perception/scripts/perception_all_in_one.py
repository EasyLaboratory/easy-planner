...
def fake_perception_callback(rgb_msg):
    ...
    odom_msg.pose.pose.position.z = 10.0
    odom_msg.pose.pose.orientation.x = 0.0
    odom_msg.pose.pose.orientation.y = 0.0
    odom_msg.pose.pose.orientation.z = 0.0
    odom_msg.pose.pose.orientation.w = 1.0
    ...
    rospy.loginfo("fake_perception_callbackfake_perception_callbackfake_perception_callback")

def sensor_perception():
    rospy.init_node('airsim_image_subscriber', anonymous=True)
    print("sensor_perception")
    ...
    rgb_sub = rospy.Subscriber(rgb_topic, Image, fake_perception_callback)
